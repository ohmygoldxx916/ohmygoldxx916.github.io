...
document.addEventListener('DOMContentLoaded', function() {
        ...
        comments.slice(startIndex, endIndex).forEach((comment, index) => {
            ...
            commentElement.innerHTML = `
                ...
                <div class="comment-actions">
                    <button class="like-btn" onclick="toggleLike(this)" data-comment-id="${comment.timestamp}">
            ...
            if (likedComments.includes(comment.timestamp)) {
    ...
    window.toggleLike = function(button) {
        ...
        // 找到对应的评论
        const comment = comments.find(c => c.timestamp === parseInt(commentId));
        if (comment) {
